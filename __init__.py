...
# 导入 Gemini 3.1 图片生成节点
from .gemini_3_1_image_node import (
    NODE_CLASS_MAPPINGS as NODE_CLASS_MAPPINGS_GEMINI_3_1,
    NODE_DISPLAY_NAME_MAPPINGS as NODE_DISPLAY_NAME_MAPPINGS_GEMINI_3_1
)
...
NODE_CLASS_MAPPINGS = {
    ...
    **NODE_CLASS_MAPPINGS_GEMINI_3_1,
...
NODE_DISPLAY_NAME_MAPPINGS = {
    ...
    **NODE_DISPLAY_NAME_MAPPINGS_GEMINI_3_1,
